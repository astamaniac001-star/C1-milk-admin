...
const ALLOWED_ORIGIN =
  process.env.ALLOWED_ORIGIN || "https://c1milk.netlify.app";
...
export const checkOrigin = (event, corsHeaders) => {
  ...
  if (
    ALLOWED_ORIGIN &&
    origin.toLowerCase() !== ALLOWED_ORIGIN.replace(/\/$/, "").toLowerCase()
  ) {
  ...
  try {
    ...
    finalBody = JSON.stringify({
      ...
      error: {
        ...
        message: "Upstream returned a non-JSON response. Check Netlify logs.",
      },
    });
  }
