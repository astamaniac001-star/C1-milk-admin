    ...
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100vh", flexDirection: "column", fontFamily: "sans-serif" }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "10px", width: "200px" }}>
        <input 
          ...
          placeholder="****"
          style={{ padding: "10px", fontSize: "24px", textAlign: "center", letterSpacing: "10px" }}
          autoFocus
        />
        <button type="submit" disabled={loading || pin.length !== 4} style={{ padding: "10px", fontSize: "16px", cursor: "pointer" }}>
